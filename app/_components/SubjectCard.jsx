...
const SubjectCard = ({ title, desc, img }) => {
  return (
    <>
      <div className="bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] group flex flex-col bg-silver bg-opacity-50 hover:bg-opacity-90 gap-y-5 pt-2 cursor-pointer pb-5 rounded-xl w-60 sm:w-[85dvw] border border-1 border-text/10  hover:translate-y-[-10px] transition ease-in">
